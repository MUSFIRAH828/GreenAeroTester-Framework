...
def _variable_block(theme: dict) -> str:
    ...
    /* --- Sidebar nav: left padding so page names aren't glued to the edge --- */
    [data-testid="stSidebarNav"] ul li a {{
        padding-left: 22px !important;
    }}

    /* --- Sidebar nav: highlight the currently active page --- */
    [data-testid="stSidebarNav"] ul li a[aria-current="page"] {{
        background-color: var(--gat-accent-soft);
        border-left: 3px solid var(--gat-accent);
